...
> ⚠️ **아이템 ID는 추측 금지.** 실제 jar/레지스트리 확인 전에는 모두 `TODO: item id 확인 필요`.
> 검증 방법(향후): 클라/서버 인스턴스에서 각 모드 아이템 레지스트리 덤프(예: `/give @s ` 자동완성, JEI/EMI 검색, 또는 jar의 `assets/.../lang/en_us.json` · 데이터) 확인.
...
|---|---|---|---|---|---|
| Poké Ball | `TODO: item id 확인 필요` (cobblemon) | 50 | 판매 | 없음 | 제작 가능 추정 |
| Great Ball | TODO | 120 | 판매 | 없음 | |
| Ultra Ball | TODO | 300 | 판매 | 없음 | |
| Premier Ball | TODO | 50 | 판매 | 없음 | |
| Heal Ball | TODO | 120 | 판매 | 없음 | |
| Net Ball | TODO | 120 | 판매 | 없음 | |
| Dive Ball | TODO | 120 | 판매 | 없음 | |
| Dusk Ball | TODO | 120 | 판매 | 없음 | |
| Quick Ball | TODO | 150 | 판매 | 없음 | |
| Timer Ball | TODO | 120 | 판매 | 없음 | |
| Repeat Ball | TODO | 120 | 판매 | 없음 | |
| Luxury Ball | TODO | 200 | 판매 | 없음 | |

### 회복 아이템
| 상품 | 아이템 ID | 가격(예시) | 판매 | 해금 | 비고 |
|---|---|---|---|---|---|
| Potion | TODO | 30 | 판매 | 없음 | |
| Super Potion | TODO | 100 | 판매 | 없음 | |
| Hyper Potion | TODO | 250 | 판매 | 없음 | |
| Max Potion | TODO | 500 | 판매 | 없음 | |
| Revive | TODO | 400 | 판매 | 없음 | |
| Full Heal | TODO | 120 | 판매 | 없음 | |
| Antidote | TODO | 30 | 판매 | 없음 | |
| Paralyze Heal | TODO | 30 | 판매 | 없음 | |
| Awakening | TODO | 30 | 판매 | 없음 | |
| Burn Heal | TODO | 30 | 판매 | 없음 | |
| Ice Heal | TODO | 30 | 판매 | 없음 | |
...
| 상품 | 아이템 ID | 가격(예시) | 판매 | 해금 | 비고 |
|---|---|---|---|---|---|
| Exp. Share / 학습장치 | TODO | 5,000 | 판매 | 배지 1~2 | 존재/획득경로 확인 |
| Rare Candy / 이상한 사탕 | TODO | 800 | 판매 | 없음 | 비싸게(주간 제한 X) |
| Lucky Egg / 행운의알 | TODO | TODO | 후보 | TODO | 존재 확인 필요 |

### 진화의 돌
| 상품 | 아이템 ID | 가격(예시) | 판매 | 해금 | 비고 |
|---|---|---|---|---|---|
| Fire Stone | TODO | 2,000 | 판매 | 없음 | 기본 |
| Water Stone | TODO | 2,000 | 판매 | 없음 | 기본 |
| Thunder Stone | TODO | 2,000 | 판매 | 없음 | 기본 |
| Leaf Stone | TODO | 2,000 | 판매 | 없음 | 기본 |
| Ice Stone | TODO | 2,500 | 판매 | 배지 2~4 | 희귀 후보 |
| Moon Stone | TODO | 2,500 | 판매 | 배지 2~4 | 희귀 후보 |
| Sun Stone | TODO | 2,500 | 판매 | 배지 2~4 | 희귀 후보 |
| Shiny Stone | TODO | 3,000 | 판매 | 배지 2~4 | 희귀 후보 |
| Dusk Stone | TODO | 3,000 | 판매 | 배지 2~4 | 희귀 후보 |
| Dawn Stone | TODO | 3,000 | 판매 | 배지 2~4 | 희귀 후보 |
...
| 상품 | 아이템 ID | 판매 | 해금 | 비고 |
|---|---|---|---|---|
| HP Up / Protein / Iron / Calcium / Zinc / Carbos | TODO | 판매 | 없음 | EV, 적극 판매 |
| PP Up / PP Max | TODO | 판매 | 배지 후보 | |
...
|---|---|---|---|---|
| Adamant/Modest/Jolly/Timid/Bold/Calm/Careful/Impish… (민트류 전체) | TODO | 중고가 | 후보 | 종류 전체 확인 필요 |

### 특성
| 상품 | 아이템 ID | 판매 | 비고 |
|---|---|---|---|
| Ability Capsule | TODO | 후보 | 밸런스 영향 — 도입 전 검토 |
| Ability Patch | `TODO: 존재 여부 확인 필요` | 보류 | 숨은특성 — 존재/밸런스 검토 |
...
| 일반/기타 메가스톤 | `mega_showdown:<name>ite` ✅ (absolite/garchompite/lucarionite…) | 일반~고급 | 메가팔찌 보유 | 다수 확인 |
| 원시회귀 | `mega_showdown:blue_orb`(가이오가) ✅ / red_orb(추정) | 후보 | 후반 | |
...
## 검증 TODO 요약
1. **SimpleTMs**: 제공 TM/TR 목록, 각 아이템 ID, TR 제공 여부, TM/TR Case 존재.
2. **Eggs Addon**: 알 종류, 각 아이템 ID, 타입별/스타팅/화석/드래곤/Shiny 알 제공 여부.
3. **Mega Showdown**: 메가팔찌·메가스톤(Charizardite X/Y 포함) 아이템 ID, 원시회귀/레쿠쟈 아이템.
4. **Cobblemon 기본**: 볼/회복약/진화의 돌/진화 아이템/비타민/민트/Ability Capsule/Hyper Training Candy 실제 존재 항목·ID·획득 경로(제작/채굴 여부).
5. 위 확인 후 본 카탈로그의 `TODO`를 실제 ID로 교체, 가격은 운영 지표로 튜닝.
