...
import kr.zenon.moncore.config.EconomyConfig.PokemonRewards;
...
public final class WildRewardService {
    ...
    private static void onCapture(PokemonCapturedEvent e) {
        try {
            ...
            ZenonMonCore.LOGGER.error("[WildReward] onCapture 실패", t);
        }
    }
    ...
    private static void onVictory(BattleVictoryEvent e) {
        try {
            ...
            ZenonMonCore.LOGGER.error("[WildReward] onVictory 실패", t);
        }
    }
}
