...
import kr.zenon.moncore.config.EconomyConfig.EngineeringConfig;
import kr.zenon.moncore.data.ZenonMonState;
import kr.zenon.moncore.economy.EconomyBridge;
import kr.zenon.moncore.item.MakeoverStone;
 ...
 * 정수를 포켓몬에 우클릭 → 영구 해제(ZenonMonCore). 여기선 해제된 포켓몬에 기술 각인(각인마다 골드).
