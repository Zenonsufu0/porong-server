...
public final class TpaManager {
    ...
    public static void request(ServerPlayerEntity requester, String targetName) {
        ...
        Text accept = Text.literal(" §a§l[수락]").styled(s ->
                s.withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/zenonmon tpa accept")));
        Text deny = Text.literal(" §c§l[거절]").styled(s ->
                s.withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/zenonmon tpa deny")));
