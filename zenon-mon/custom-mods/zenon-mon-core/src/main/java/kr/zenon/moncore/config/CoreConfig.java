...
public class CoreConfig {
    ...
    /** 허브 텔레포트 목적지 (menu_design.md §3 슬롯 19, commands.md /zenonmon hub). */
    ...
    public static class End {
        ...
        // 복귀는 /zenonmon hub(오버월드 허브 TP) 사용 — 별도 엔드 귀환 포탈 불필요.
    }
    ...
    public static class DiscordAuth {
        ...
        public int httpPort = 25580;               // ZenonMonCore 인증 API 포트
