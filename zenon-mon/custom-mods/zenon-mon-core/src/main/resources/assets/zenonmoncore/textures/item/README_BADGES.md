...
- `assets/minecraft/models/item/paper.json` 가 CMD별로 `zenonmoncore:item/badge_<type>` 모델로 분기.
- `assets/zenonmoncore/models/item/badge_<type>.json` 가 위 PNG(`zenonmoncore:item/badge_<type>`)를 사용.
