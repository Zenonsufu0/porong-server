...
> **SoT:** [`docs/concept.md`](docs/concept.md) · 아이디어 이력: [`docs/idea_inbox.md`](docs/idea_inbox.md) (INBOX-001~021)
...
## 🔜 다음 세션 — 이어서 할 것
1. **최후의 결전 디테일** (남은 마지막 큰 토대) — 스캐브 랭크별 배치·행동, 피날레 연출(생존자 보상·결전 규모·발동 방식).
2. **미정 수치 채우기** (착수 임박 시 밸런싱): 연합 인원 상한, 화폐 드랍률·상점 가격, 식별 마우스오버 N초, 부위 페널티, 기지 레벨 단계 수치, Y25 초기화 타이밍.
