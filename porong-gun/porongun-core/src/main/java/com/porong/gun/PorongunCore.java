...
public final class PorongunCore {
    ...
    public PorongunCore() {
        ...
        PorongunBlocks.register(modBus);         // M-Core 코어 블록
        PorongunBlockEntities.register(modBus);  // M-Core 코어 BE
        PorongunItems.register(modBus);          // M-Material 재료 4종 + M-Core 코어 아이템
