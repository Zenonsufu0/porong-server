    ...
    public static UpgradeCost upgradeCost(int level) {
        return switch (level) {
            case 1 -> new UpgradeCost(800, List.of(
                    ...
                    new Ingredient(PorongunItems.TUNGSTEN_ALLOY.get(), 16)));
            case 2 -> new UpgradeCost(2000, List.of(
                    new Ingredient(PorongunItems.TUNGSTEN_ALLOY.get(), 32),
                    new Ingredient(Items.DIAMOND, 8)));
            case 3 -> new UpgradeCost(4000, List.of(
                    new Ingredient(PorongunItems.TUNGSTEN_ALLOY.get(), 48),
                    new Ingredient(Items.DIAMOND, 12)));
            case 4 -> new UpgradeCost(8000, List.of(
                    new Ingredient(PorongunItems.TUNGSTEN_ALLOY.get(), 64),
                    new Ingredient(PorongunItems.MILITARY_ALLOY.get(), 16),
                    new Ingredient(PorongunItems.ELECTRONIC_PART.get(), 8)));
            default -> null; // LV5 = 최고
        };
    }
