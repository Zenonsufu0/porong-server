...
import com.poro.rpg.growth.island.IslandTerritoryState.FacilityType;
...
public final class TerritoryFacilityGui {
    ...
    private static String productionTimer(long lastProducedAt) {
        long next = lastProducedAt + com.poro.rpg.growth.island.MachineProductionScheduler.intervalMs();
