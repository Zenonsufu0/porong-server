...
import com.poro.rpg.boss.engine.BossRunRecordHook;
...
public final class DbBossRunRecordHook implements BossRunRecordHook {
    ...
    private final com.poro.rpg.boss.room.BossDamageTracker damageTracker;
    ...
    public DbBossRunRecordHook(BossSessionRepository repository, long seasonStartEpoch,
                               ...
                               com.poro.rpg.boss.room.BossDamageTracker damageTracker) {
