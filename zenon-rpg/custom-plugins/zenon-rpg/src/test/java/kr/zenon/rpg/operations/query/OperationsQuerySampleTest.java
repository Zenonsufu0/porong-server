...
import kr.zenon.rpg.boss.engine.InMemoryBossRunRecordHook;
...
import kr.zenon.rpg.life.engine.EstateHarvestLogEntry;
import kr.zenon.rpg.life.engine.EstateSnapshotBuilder;
import kr.zenon.rpg.life.engine.InMemoryEstateHarvestLogHook;
import kr.zenon.rpg.life.engine.InMemoryLifeCraftLogHook;
import kr.zenon.rpg.life.engine.LifeCraftLogEntry;
import kr.zenon.rpg.life.engine.LifeEngineRuntime;
import kr.zenon.rpg.operations.query.api.AdminApiEndpointLayer;
import kr.zenon.rpg.operations.query.discord.DiscordCardResponse;
...
import kr.zenon.rpg.quest.engine.InMemoryHallOfFameHook;
import kr.zenon.rpg.quest.engine.InMemoryQuestRecordRewardHook;
import kr.zenon.rpg.quest.engine.InMemorySymbolicHonorHook;
import kr.zenon.rpg.quest.engine.PlayerQuestAndHonorSnapshotBuilder;
import kr.zenon.rpg.quest.engine.PlayerQuestHonorState;
...
class OperationsQuerySampleTest {
    ...
    void shouldBuildAdminAndDiscordQueryResponses() {
        ...
        hallHook.onAchievementRecorded(
                ...
                new kr.zenon.rpg.common.registry.master.model.AchievementMaster(
                        "ach_extreme_carmen",
                        "special",
                        "Extreme Vanguard",
                        "EXTREME_CLEAR",
