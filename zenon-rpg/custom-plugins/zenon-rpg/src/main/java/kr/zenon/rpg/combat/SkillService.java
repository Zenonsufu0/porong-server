...
public class SkillService {
    ...
    private kr.zenon.rpg.admin.AdminTogglesService toggles;   // 테스트용 쿨 우회 토글(나중 주입)
    ...
    public void attachToggles(kr.zenon.rpg.admin.AdminTogglesService toggles) {
    ...
    public boolean useSkill(Player player, String rawSkillKey) {
        ...
        boolean noCooldown = toggles != null
                && toggles.isOn(kr.zenon.rpg.admin.AdminTogglesService.Toggle.NO_SKILL_COOLDOWN);
