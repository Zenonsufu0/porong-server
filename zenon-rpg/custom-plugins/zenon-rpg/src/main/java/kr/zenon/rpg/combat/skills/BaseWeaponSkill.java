...
import kr.zenon.rpg.combat.DamageNumberService;
...
public abstract class BaseWeaponSkill implements WeaponSkill {
    ...
    protected void dealDamage(SkillContext ctx, Player attacker, LivingEntity target, double rawDamage) {
        double dmg = rawDamage
                ...
                * ctx.skillTypeMultiplier(attacker, kr.zenon.rpg.combat.SkillType.fromKey(key()))
        ...
        kr.zenon.rpg.combat.SkillDamageGuard.run(() -> target.damage(finalDmg, attacker));
