...
public final class BossRewardService implements BossRewardResolverHook {
    ...
    private kr.zenon.rpg.boss.party.PartyManager partyManager; // 클리어 시 파티 해산
    ...
    public void attachClearFlow(org.bukkit.plugin.Plugin plugin, kr.zenon.rpg.boss.party.PartyManager partyManager) {
        this.plugin = plugin;
    ...
    private void handleRunExit(java.util.List<UUID> ids, boolean clear, String bossId,
        ...
        String bossName = kr.zenon.rpg.gui.BossHubGui.bossNameById(bossId);
        for (UUID id : ids) {
