...
> **[STATUS: CANON]** — 플러그인 경계, ZenonRPG 책임 범위, 부트스트랩 순서, 운영 명령어의 공식 기준.
...
|---|---|
| 코어 플러그인 | ZenonRPG |
| ZenonRPG 책임 | 전투, 장비, 영지, 보스, 보상, DB, API, Discord/web 연동 데이터 |
...
이 폴더의 다른 문서가 Citizens 사용, NPC 기반 진행, 또는 ZenonRPG 외부 플러그인이 핵심 데이터를 소유하는 구조를 전제하면 이 문서와 `../final_master_plan.md`를 우선한다.
