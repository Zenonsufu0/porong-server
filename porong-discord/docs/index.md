# 포롱서버 중앙제어 디스코드 봇 — 문서 인덱스

> **[STATUS: ACTIVE]** — porong-discord 봇 설계/운영 문서의 진입점.
> 봇 작업 규칙은 [`../CLAUDE.md`], 모노레포 전역 SoT 는 `../../porong-rpg/docs/final_master_plan.md`.

## 이 봇은 무엇인가

하나의 디스코드 서버에서 동작하는 **포롱서버 전체 중앙제어 봇**이다.
