 ...
 */
public final class ZenonGunItems {

    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, ZenonGunCore.MODID);
    ...
    public static final RegistryObject<Item> CORE =
            ITEMS.register("core", () -> new BlockItem(ZenonGunBlocks.CORE.get(), new Item.Properties()));
