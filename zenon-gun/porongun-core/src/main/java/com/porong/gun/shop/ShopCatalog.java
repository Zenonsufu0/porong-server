...
public final class ShopCatalog {
    ...
    public static final List<ShopEntry> ENTRIES = List.of(
            ...
            ShopEntry.of("porongun:tungsten_alloy", 30, 6),   // 파밍 재료=구매 가능
            ShopEntry.of("porongun:depleted_uranium", -1, 20),
            ShopEntry.of("porongun:military_alloy", -1, 60),  // 비파밍 게이트=구매 불가
            ShopEntry.of("porongun:electronic_part", -1, 80)  // 비파밍 게이트=구매 불가
    );
