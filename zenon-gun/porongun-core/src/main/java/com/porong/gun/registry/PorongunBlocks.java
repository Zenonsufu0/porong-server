...
import com.porong.gun.block.CoreBlock;
 ...
 */
public final class PorongunBlocks {

    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, PorongunCore.MODID);
