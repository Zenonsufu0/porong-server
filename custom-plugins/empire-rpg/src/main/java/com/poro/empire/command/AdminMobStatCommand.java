...
import com.poro.empire.admin.config.MobStatOverride;
import com.poro.empire.admin.config.MobStatOverrideService;
 ...
 * <pre>
 *   /empire-mobstat list
 *   /empire-mobstat get  &lt;mobKey&gt;
 *   /empire-mobstat set  &lt;mobKey&gt; &lt;hp|def|atk&gt; &lt;value|none&gt;
 *   /empire-mobstat reset &lt;mobKey&gt;
 * </pre>
 *
...
public final class AdminMobStatCommand implements CommandExecutor {
    ...
    private void usage(CommandSender sender) {
        ...
        sender.sendMessage("§7/empire-mobstat list");
        sender.sendMessage("§7/empire-mobstat get <mobKey>");
        sender.sendMessage("§7/empire-mobstat set <mobKey> <hp|def|atk> <value|none>");
        sender.sendMessage("§7/empire-mobstat reset <mobKey>");
