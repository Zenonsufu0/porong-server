...
import com.poro.rpg.boss.db.DbBossRunRecordHook;
...
public final class BossEngineBootstrap {
    ...
    public static Result<BossEngineRuntime> bootstrap(
            ...
            com.poro.rpg.boss.db.BossParticipantSpecResolver participantSpecResolver,
            com.poro.rpg.boss.room.BossDamageTracker bossDamageTracker,
            com.poro.rpg.boss.room.BossRoomManager bossRoomManager
    ) {
