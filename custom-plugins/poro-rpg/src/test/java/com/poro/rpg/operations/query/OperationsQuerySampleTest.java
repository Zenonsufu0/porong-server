...
import com.poro.rpg.boss.engine.InMemoryBossRunRecordHook;
...
import com.poro.rpg.growth.engine.InMemoryEnhancementLogHook;
...
import com.poro.rpg.life.engine.InMemoryEstateHarvestLogHook;
import com.poro.rpg.life.engine.InMemoryLifeCraftLogHook;
...
import com.poro.rpg.quest.engine.InMemoryHallOfFameHook;
import com.poro.rpg.quest.engine.InMemoryQuestRecordRewardHook;
import com.poro.rpg.quest.engine.InMemorySymbolicHonorHook;
import com.poro.rpg.quest.engine.PlayerQuestAndHonorSnapshotBuilder;
import com.poro.rpg.quest.engine.PlayerQuestHonorState;
...
class OperationsQuerySampleTest {
    ...
    void shouldBuildAdminAndDiscordQueryResponses() {
        ...
        hallHook.onAchievementRecorded(
                ...
                new com.poro.rpg.common.registry.master.model.AchievementMaster(
                        "ach_extreme_carmen",
                        "special",
                        "Extreme Vanguard",
                        "EXTREME_CLEAR",
