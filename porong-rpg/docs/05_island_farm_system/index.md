...
| 화면 | 설계 문서 |
|---|---|
| 영지 서브 허브 | `porong-rpg/docs/08_resourcepack_pipeline/gui_hub_structure.md §4` |
| 공방 GUI | 현행 기준 재작성 필요 |
| 영지상태 GUI | 현행 기준 재작성 필요 |
| 영지 저장고 GUI | `porong-rpg/docs/08_resourcepack_pipeline/gui_storage.md` |
| 영지설정 GUI | `porong-rpg/docs/08_resourcepack_pipeline/gui_territory_settings.md` |
| 작물관리 GUI | `porong-rpg/docs/08_resourcepack_pipeline/gui_crop_management.md` |
