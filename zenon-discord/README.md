...
Zenon 서버 **중앙제어** 디스코드 봇. RPG·Zenon Mon·공지·역할·이벤트·운영자 명령어를
관리하는 운영 허브다. 실제 게임 로직은 RPG 플러그인/Zenon Mon 서버가 담당하고,
...
도메인별 모듈 분리: RPG/Zenon Mon은 서로 import 하지 않는다. 자세한 작업 규칙은
