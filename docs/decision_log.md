...
**근거:** `final_master_plan.md §4` (플러그인 구조, 2026-05-20 기준)
...
**근거:** `final_master_plan.md §8` (개인 영지) + `economy_numbers_v2.md §2` (2026-05-19 설계 변경 주석)
...
**근거:** `final_master_plan.md §6` (전투와 장비 성장, 2026-05-20 기준)
...
**근거:** `weapon_skills_v1.md §2` + `final_master_plan.md §6` (전투와 장비 성장)
...
**변경:** `### 강화 비용표` 섹션 전체를 `final_master_plan §6` (전투와 장비 성장, M-3 확정 2026-05-20) 기준으로 교체  
  > 참고: §7.3은 구조조정 이전 섹션 번호. 현재 final_master_plan에서는 §6으로 통합됨.  
**상세 변경:**
...
**이유:** economy_numbers_v2가 2026-05-15 기준 수치이고, final_master_plan §6은 2026-05-20 M-3 확정 기준. 최신 확정이 우선.  
**근거:** `final_master_plan.md §6` (전투와 장비 성장) M-3 (2026-05-20)
...
**근거:** `final_master_plan.md §8` (개인 영지) + `economy_numbers_v2.md §2` (2026-05-19 주석)
...
**제거 및 위임 목록:** (아래 §번호는 구조조정 이전 final_master_plan 섹션 번호임)
