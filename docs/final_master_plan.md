...
| 항목 | 상태 | 담당 문서 |
|---|---|---|
| 강화석 드랍률 최종 수치 | 검토 중 | `docs/06_fields_bosses/drop_tables_v1.md` 기준으로 재정리 필요. 구 계산 문서 `docs/_archive/enhancement_droprate_v1.md`는 현재 기준 아님 |
| 21~25강 강화 성공률 재조정 | 검토 중 — 현행 유지 유력 (DL-014 이후 블로커 해소) | `docs/02_database_api_stats/economy_numbers_v2.md` |
