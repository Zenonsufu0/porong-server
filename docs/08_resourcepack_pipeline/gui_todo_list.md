...
| [설계완료] | 강화 GUI | 54 | `gui_functional_specs.md §1` | 장비 선택(우)→중앙, 강화버튼, 가호카운터 |
| [설계완료] | 잠재능력 큐브 GUI | 54 | `gui_functional_specs.md §2` | 현재/결과 좌우 패널, 유지·계속사용·적용 |
| [설계완료] | 각인/스킬 선택 GUI | 27 | `gui_functional_specs.md §3` | 슬롯 1개, 교체비용 없음 |
| [설계완료] | 전승 GUI | 54 | `gui_functional_specs.md §4` | 흔적→대상, 전승권 3종 슬롯 |

### 3-3. 영지 계열

| 상태 | 화면 | 슬롯 | 설계문서 | 비고 |
|:---:|---|:---:|---|---|
| [설계완료] | 영지 상태 GUI | 27 | `gui_territory_status.md` | 작위·마력·발전기·가공기·편의해금 |
| [설계완료] | 창고 GUI | 54 | `gui_storage.md` | 아이템 입출고 |
| [설계완료] | 공방 GUI | 27 | `gui_functional_specs.md §5` | 대기열 5~12슬롯, 레시피 5종 |
...
| [설계완료] | 보스 정보 GUI | 27 | `gui_boss_info.md` | 4보스 선택·lore 요약·상세 뷰 전환 |
