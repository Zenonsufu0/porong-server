...
### 영지 서브 허브 (54슬롯, menu_hub_territory.png)
```
...
이동=9,10,18,19 / 상태=11,12,20,21 / 창고=13,14,22,23 / 공방=15,16,24,25
시설=27,28,36,37 / 상점=29,30,38,39 / 경매=31,32,40,41 / 설정=33,34,42,43
```

### 보스 서브 허브 (54슬롯, menu_hub_boss.png)
```
     col0  col1  col2  col3  [col4]  col5  col6  col7  col8
