...
| 상태 | 화면 | 슬롯 | 설계문서 | 비고 |
|:---:|---|:---:|---|---|
| [재작성필요] | 보스 방 만들기 — Anvil | — | 현행 기준 문서 필요 | 텍스트 입력(제목) |
| [재작성필요] | 보스 방 설정 GUI | 54 | 현행 기준 문서 필요 | 보스선택·최소강화·최대인원·개설 |
| [재작성필요] | 보스 방 목록 GUI | 54 | 현행 기준 문서 필요 | lore: 제목·보스·인원·최소강화 |
| [재작성필요] | 보스 방 내부 GUI | — | 현행 기준 문서 필요 | 파티원 상태·강퇴·준비 확인 |
| [재작성필요] | 보스 정보 GUI | 54 | 현행 기준 문서 필요 | 필드/보스 CANON 기준으로 재작성 |
| [재작성필요] | 클리어 기록 GUI | 27 | 현행 기준 문서 필요 | 클리어 횟수·최단기록·트로피 |
