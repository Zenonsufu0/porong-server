...
| `numbers_and_open_decisions.md` | 마력 시스템(T-6) 등 구 미결정 항목 포함. 현행 미확정 항목은 `§13`에서 관리. | `docs/final_master_plan.md §13` |
...
| `11_remaining_decisions/index.md` | 미결정 항목 대부분이 `final_master_plan.md`와 각 도메인 문서에 흡수됨. | `docs/final_master_plan.md §13`, `docs/decision_log.md` |
