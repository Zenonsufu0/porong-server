...
- 상태: 코드 블로커 수정 진행 중 (DL-091)
  ...
  - 🟠 **신규 발견(2026-05-31): 치명 %/pt 충돌** — `level_stat_system_v1 §3` = 0.3%/pt(150pt=45%) vs `potential_options_v1 §치명 5%행` = 0.45%/pt(100% 캡 math 기준). #7 코드(DL-092)는 0.3%/pt 사용 → 정본 확정 필요(0.45면 코드+level_stat 수정)
