...
public final class MenuItemManager {
    ...
    public static final String TAG_KEY = "poromon_league_pass";
    ...
    public static ItemStack createPass(CoreConfig.MenuItem cfg) {
        ...
        if (id != null && Registries.ITEM.containsId(id)) {
            ...
            PoroMonCore.LOGGER.warn("[MenuItem] itemId '{}' 미해석 → 기본 minecraft:clock 사용", cfg.itemId);
        }
        ...
        stack.set(DataComponentTypes.LORE, new LoreComponent(List.of(
                Text.literal("우클릭 — 포로몬 메뉴 열기").formatted(Formatting.GRAY),
                Text.literal("/poromon menu 로도 열 수 있습니다").formatted(Formatting.DARK_GRAY)
        )));
        return stack;
    }
    ...
    private static boolean place(ServerPlayerEntity player, PlayerInventory inv, CoreConfig.MenuItem cfg) {
        ...
        PoroMonCore.LOGGER.warn("[MenuItem] 인벤토리 가득 — 리그 패스 지급 보류: {}",
